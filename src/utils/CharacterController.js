...
import {CharacterControllerProxy} from './CharacterController/CharacterControllerProxy.js';
import {ChararacterControllerInput} from './CharacterController/CharacterControllerInput.js';
import {CharacterFiniteStateMachine} from './CharacterController/CharacterFiniteStateMachine.js';
...
export function CharacterController(params) {
    ...
    this.update = function(timeInSecods) {
        ...
        if(this._stateMachine._currentState.getName() === "pettingAnimalLong0")
        ...
        if(this._input._keys.left) {
            _A.set(0,1,0);
            _Q.setFromAxisAngle(_A, 4.0 * Math.PI * timeInSecods * this._acceleration.y);
            _R.multiply(_Q);
        }
